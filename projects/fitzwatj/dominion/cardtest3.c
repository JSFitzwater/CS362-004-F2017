...
//
    ...
    printf( "Current Player Gold:\n - gold coins now held: %d \n - num gold should be: %d\n\n", scratchGame.coins[currentPlayer], origGame.coins[currentPlayer] + (cutpurseGold) );
    ...
    assert( scratchGame.coins[currentPlayer] == origGame.coins[currentPlayer] + (cutpurseGold) );

    assert( scratchGame.handCount[currentPlayer] == origGame.handCount[currentPlayerPlayer]- 1 );
    ...
    assert( scratchGame.coins[currentPlayer] == origGame.coins[currentPlayer] - (cpprDiscaard) );
